...
public class GpsInfo extends Service implements LocationListener {
    ...
    boolean isGetLocation = false;  //Location 사용 유무
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10; // 최소 GPS 정보 업데이트 시간
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) { // GPS 와 네트워크사용이 가능하지 않을때 소스 구현
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {      //받아온 위치가 NULL이면
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setMessage("GPS 셋팅이 되지 않았을수도 있습니다. \n 설정창으로 가시겠습니까?"); // OK 를 누르게 되면 설정창으로 이동합니다.
        alertDialog.setPositiveButton("Settings", new DialogInterface.OnClickListener() {

            public void onClick(DialogInterface dialog,int which) {
                Intent intent = new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS);
                mContext.startActivity(intent); } }); // Cancle 하면 종료
